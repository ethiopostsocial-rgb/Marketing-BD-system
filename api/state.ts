...
// Credentials — override via Vercel env vars, or use these baked-in defaults
const GITHUB_TOKEN  = process.env.GITHUB_TOKEN  ?? "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";
